...
view model = 
    if model.mainscreen == True then
       div [Html.Attributes.style [("text-align","center"),("background-image", "url(\"Clouds.jpg\")"),("height", "100%")]] [
        ...
        p [Html.Attributes.style[("font-family", "\"Comic Sans ms\",cursive,sans serif")  ]] [Html.text "Marge promises to make food for whoever wins these races. Help Homer outrun Maggie,Bart and Lisa in 3 increasingly harder races by tapping the left and right arrow keys alternately"],
        ...
        div [Html.Attributes.style [("text-align","center"),("background-image", "url(\"happyhomer.png\")"),("background-color","lightblue"),("height", "100%"),("background-repeat", "no-repeat")]] [
            header [ Html.Attributes.style []] [
            img [src"won.png", Html.Attributes.style [("text-align", "center")]] []
                  ],
            audio [Html.Attributes.src "./woho.wav", Html.Attributes.autoplay True] [],
            svg [    Svg.Attributes.width "1250",  Svg.Attributes.height "400"] [],
            section [] [
        ...
        div [Html.Attributes.style [("text-align","center"),("background-image", "url(\"homerblue.jpg\")"),("height", "100%"),("background-size", "1400px 700px"),("background-repeat", "no-repeat"),("background-position","top top")]] [
        ...
        div [Html.Attributes.style [("text-align","center"),("background-image", "url(\"sadhomer.png\")"),("background-color","white"),("height", "100%"),("background-repeat", "no-repeat")]] [
        header [ Html.Attributes.style []] [
